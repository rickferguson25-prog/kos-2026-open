(() => {
  ...
  function downloadTemplate() {
    ...
    downloadCsv("open_championship_pool_entrants_template.csv", lines);
  }
  ...
  function exportCurrentGroupsCsv() {
    ...
    downloadCsv("open_championship_pool_current_groups.csv", rows.map(row => row.map(csvEscape).join(",")).join("\n"));
  }
